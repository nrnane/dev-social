    ...
    return(
        ...
        you have attended
                ...
                <form className="form" onSubmit={e=>{
                    ...
                    <input type="text" placeholder="* School or Bootcamp" name="school" value={school} onChange={e=>formUpdate(e)} required />
                    </div>
                    <div className="form-group">
                    <input type="text" placeholder="* Degree or Certificate" name="degree" value={degree} onChange={e=>formUpdate(e)}  required />
                    </div>
                    <div className="form-group">
                    <input type="text" placeholder="Field Of Study" value={fieldofstudy} onChange={e=>formUpdate(e)}  name="fieldofstudy" />
                    </div>
                    <div className="form-group">
                    <h4>From Date</h4>
